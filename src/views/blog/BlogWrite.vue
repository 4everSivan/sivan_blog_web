...
<!--          <div class="me-write-info">Write Something ...</div>-->
<!--        </el-col>-->
        <el-col :span="3" :offset="17">
          <div class="me-write-btn">
            <el-button
              size="mini"
              type="success"
              style="background-color: white;color: #5fb878;border: 1px #5fb878 solid"
              round
              @click="publishShow">发布
            </el-button>
            <el-button size="mini"
                       type="warning"
                       style="background-color: white;color: #e6a23c;border: 1px solid #e6a23c"
                       round
                       @click="cancel">取消
            </el-button>
          </div>
      ...
      <el-dialog title="摘要 分类 标签"
        ...
        <div slot="footer" class="dialog-footer">
          <el-checkbox v-model="isPrimary" style="margin-right: 10px"  name="isTop">是否私密</el-checkbox>
          <el-checkbox v-model="isTop" style="margin-right: 10px"  name="isTop">是否置顶</el-checkbox>
      ...
      return {
        ...
        rules: {
          summary: [
            ...
            {max: 180, message: '不能大于80个字符', trigger: 'blur'}
          ],
          category: [
    ...
    methods: {
      getArticleById(id) {
        ...
        getArticleById(id).then(data => {
          ...
          that.articleForm.bodyId = data.data.bodyId
          console.log(that.articleForm.bodyId)
        ...
        this.$refs[articleForm].validate((valid) => {
          if (valid) {
            ...
            if (this.isTop == true){
              ...
              this.articleForm.weight = 0;
            }
            if (this.isPrimary == true){
              this.articleForm.primaryId = 1;
            }else {
              this.articleForm.primaryId = 0;
            }
            let article = {
              ...
              primaryId: this.articleForm.primaryId,
              tags: tags,
              body: {
                content: this.articleForm.editor.value,
                contentHtml: this.articleForm.editor.ref.d_render
              },
              bodyId: that.articleForm.bodyId
            }
