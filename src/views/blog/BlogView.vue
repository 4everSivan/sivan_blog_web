        ...
        <div class="me-view-card">
          ...
          <div class="me-view-author">
            ...
            <el-button
              ...
              @click="editArticle()"
              style="position: absolute;left: 64%;color: #5fb878;border: 1px solid #5fb878;margin-top: 15px"
              size="mini"
              round
            ...
            <el-button
              ...
              type="danger"
              round
              style="position: absolute;left: 69.5%;margin-top: 15px;background-color: white;color: #f56c6c;"
              size="mini"
              icon="el-icon-delete"
            >删除</el-button>
          </div>
    ...
    methods: {
      ...
      articleDelete(){
        this.$confirm('此操作将永久删除该文章, 是否继续?', '提示', {
          ...
          let that = this
          this.articleId = that.$route.params.id
          deleteArticle(this.articleId).then( data => {
            if (data.success){
